        ...
        items: [
            ...
            },
            {
                ...
                submenu: [
                    ...
                    {
                        url: "/admin/import-export/export-selected",
        ...
        items: [
            {
                ...
                submenu: [
                    ...
                    {
                        url: '/admin/admin/forms/form-elements/number-input',
                        name: "Number Input",
            ...
            {
                url: "/admin/ui-elements/ag-grid-table",
                name: "agGrid Table",
                slug: "ag-grid-table",
                icon: "GridIcon",
                i18n: "agGridTable",
