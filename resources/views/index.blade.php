                                                ...
                                                <form action="#" method="post" enctype="multipart/form-data"
                                                    ...
                                                    <div class="btn-group">
                                                        <button class="btn-link dropdown-toggle" data-toggle="dropdown">
                                                            <img src="{{ asset('public') }}/image/catalog/flags/gb.png" alt="English"
                                                                title="English">
                                                            <span
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <button class="btn-block language-select" type="button"
                                                                    name="ar-ar"><img src="{{ asset('public') }}/image/catalog/flags/ar.png"
                                                                        alt="Arabic" title="Arabic"> Arabic</button>
                                                            </li>
                                                            <li>
                                                                <button class="btn-block language-select" type="button"
                                                                    name="en-gb"><img src="{{ asset('public') }}/image/catalog/flags/gb.png"
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="navbar-logo col-lg-3 col-md-12 col-xs-12">
                                <a href="index6.php"><img src="{{ asset('public') }}/image/catalog/demo/logo/logo-home6.png"
                                            ...
                                            <div id="search0" class="search input-group form-group">
                                                <div class="select_category filter_type  icon-select">
                                                    <select class="no-border" name="category_id">
                                                        ...
                                                        <option value="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hanet
                                                            magente </option>
                                                        <option value="41">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Knage unget
                                                        </option>
                                                        <option value="42">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Latenge
                                                            mange </option>
                                                        ...
                                                        <option value="90">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Laptops
                                                        </option>
                                                        <option value="78">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Mobiles
                                                        </option>
                                                        <option value="79">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sound
                                                        </option>
                                                        <option value="80">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; USB &amp;
                                                            HDD </option>
                                                ...
                                                <div class="shopcart">
                                                    ...
                                                    <div class="cart-info">
                                                        ...
                                                        <span class="total-shopping-cart cart-total-full">
                                                            <span class="items_cart">2 </span><span
                                                                class="items_cart2">item(s)</span><span class="items_carts">
                                                                - $206.80</span>
                                                        </span>
                                                    </div>
                                                </div>
                                                            ...
                                                            <tr>
                                                                <td class="text-center size-img-cart">
                                                                    <a href="product.html"><img
                                                                            src="{{ asset('public') }}/image/catalog/demo/product/travel/10-54x54.jpg"
                                                                            alt="Bougainvilleas on Lombard Street,  San Francisco, Tokyo"
                                                                            title="Bougainvilleas on Lombard Street,  San Francisco, Tokyo"
                                                                            class="img-thumbnail"></a>
                                                                </td>
                                                                <td class="text-left"><a href="product.html">Bougainvilleas
                                                                        on Lombard Street, San Francisco, Tokyo</a>
                                                    ...
                                                    <table class="table table-striped" style="margin-bottom:10px;">
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-center size-img-cart">
                                                                    <a href="product.html"><img
                                                                            src="{{ asset('public') }}/image/catalog/demo/product/travel/2-54x54.jpg"
                                                                            alt="Canada Travel One or Two European Facials at  Studio"
                                                                            title="Canada Travel One or Two European Facials at  Studio"
                                                                            class="img-thumbnail"></a>
                                                                </td>
                                                                <td class="text-left"><a href="product.html">Canada Travel
                                                                        One or Two European Facials at Studio</a>
                                                                    <br> - <small>Size M</small>
                                                                </td>
                                                                <td class="text-right">x1</td>
                                                                    ...
                                                                    <ul class="megamenu" data-transition="slide"
                                                                        ...
                                                                        <li class="item-vertical  style1">
                                                                            ...
                                                                            <a href="#" class="clearfix">
                                                                                <span>
                                                                                    <strong><img
                                                                                            src="{{ asset('public') }}/image/catalog/demo/menu/icon/icon-6.png"
                                                                                            alt="">Hot Deal</strong>
                                                                                </span>
                                                                            </a>
                                                                        </li>
                                                                        <li
                                                                            class="item-vertical  vertical-style2 with-sub-menu hover">
                                                                            <p class="close-menu"></p>
                                                                            <a class="clearfix">
                                                                                <span>
                                                                                    <strong><img
                                                                                            src="{{ asset('public') }}/image/catalog/demo/menu/icon/icon-1.png"
                                                                                            alt="">Electronics</strong>
                                                                                </span>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div class="html item-1">
                                                                                                <div class="row">
                                                                                                    <div
                                                                                                        class="col-lg-7 col-md-7 col-sm-8">
                                                                                                        <div
                                                                                                            class="item-3 col-lg-6 col-md-6 icon-1">
                                                                                                            <a href="#"
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="item-3 col-lg-6 col-md-6 cat-child icon-2 parent">
                                                                                                            <a href="#"
                                                                                                                title="Sound">Sound</a>
                                                                                                            <ul>
                                                                                                                <li
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="item-3 col-lg-6 col-md-6 cat-child icon-3 parent">
                                                                                                            <a href="#"
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="item-3 col-lg-6 col-md-6 cat-child icon-4 parent">
                                                                                                            <a href="#"
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="item-3 col-lg-6 col-md-6 cat-child icon-5 parent">
                                                                                                            <a href="#"
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="item-3 col-lg-6 col-md-6 icon-6">
                                                                                                            <a href="#"
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="item-3 col-lg-6 col-md-6 icon-7">
                                                                                                            <a href="#"
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="item-3 col-lg-6 col-md-6 cat-child icon-8 parent">
                                                                                                            <a href="#"
                                                                                                                title="Case">Case</a>
                                                                                                            <ul>
                                                                                                                <li
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <a href="#"><img
                                                                                                                src="{{ asset('public') }}/image/catalog/demo/menu/img-static-megamenu-h.jpg"
                                                                                                                alt="banner"></a>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                        ...
                                                                        <li
                                                                            class="item-vertical  vertical-style3 with-sub-menu hover">
                                                                            <p class="close-menu"></p>
                                                                            <a href="#" class="clearfix">
                                                                                <span>
                                                                                    <strong><img
                                                                                            src="{{ asset('public') }}/image/catalog/demo/menu/icon/icon-2.png"
                                                                                            alt="">Travel &amp;
                                                                                        Vacation</strong>
                                                                                </span>
                                                                                <b class="fa fa-caret-right"></b>
                                                                                        ...
                                                                                        <div class="col-sm-7">
                                                                                            <div class="html ">
                                                                                                <div class="row img-banner">
                                                                                                    <a href="#"><img
                                                                                                            src="{{ asset('public') }}/image/catalog/demo/menu/ver-img-1.jpg"
                                                                                                            alt="banner"></a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                        ...
                                                                        <li class="item-vertical">
                                                                            ...
                                                                            <a href="#" class="clearfix">
                                                                                <span>
                                                                                    <strong><img
                                                                                            src="{{ asset('public') }}/image/catalog/demo/menu/icon/icon-3.png"
                                                                                            alt="">Book Stationery</strong>
                                                                                </span>
                                                                            </a>
                                                                        </li>
                                                                        <li
                                                                            class="item-vertical   item-style3 with-sub-menu hover">
                                                                            <p class="close-menu"></p>
                                                                            <a class="clearfix">
                                                                                <span>
                                                                                    <strong><img
                                                                                            src="{{ asset('public') }}/image/catalog/demo/menu/icon/icon-4.png"
                                                                                            alt="">Fashion</strong>
                                                                                </span>
                                                                                <b class="fa fa-caret-right"></b>
                                                                            </a>
                                                                                                        ...
                                                                                                        <div class="menu">
                                                                                                            <ul>
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Girls
                                                                                                                                New</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Bluetooth
                                                                                                                                Speakers</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Pearl
                                                                                                                                mens</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Digital
                                                                                                                                &amp;
                                                                                                                                Electronics</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                            ...
                                                                                                            <ul>
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Bags</a>
                                                                                                                        </li>
                                                                                                                    </ul>
                                                                                                                </li>
                                                                                                            </ul>
                                                                                                            ...
                                                                                                            <ul>
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Dress
                                                                                                                                Ladies</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Jean</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Laptop
                                                                                                                                &amp;
                                                                                                                                Notebook</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div class="link banner-full">
                                                                                                <img src="{{ asset('public') }}/image/catalog/demo/menu/menu_bg2.jpg"
                                                                                                    alt=""
                                                                                                    style="width: 100%;">
                                                                                            </div>
                                                                                        </div>
                                                                        ...
                                                                        <li class="item-vertical">
                                                                            ...
                                                                            <a class="clearfix">
                                                                                <span>
                                                                                    <strong><img
                                                                                            src="{{ asset('public') }}/image/catalog/demo/menu/icon/icon-5.png"
                                                                                            alt="">Sport &amp;
                                                                                        Entertaiment</strong>
                                                                                </span>
                                                                            </a>
                                                                        ...
                                                                        <li
                                                                            ...
                                                                            <a href="#" class="clearfix">
                                                                                <span>
                                                                                    <strong><img
                                                                                            src="{{ asset('public') }}/image/catalog/demo/menu/icon/icon-8.png"
                                                                                            alt="">Spa &amp;
                                                                                        Massage</strong>
                                                                                </span>
                                                                                <b class="fa fa-caret-right"></b>
                                                                                                            ...
                                                                                                            <ul>
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Case</a>
                                                                                                                        </li>
                                                                                                                    </ul>
                                                                                                                </li>
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Fashion
                                                                                                                                &amp;
                                                                                                                                Accessories</a>
                                                                                                                        </li>
                                                                                                                        <li>
                                                                                                                            <a href="#"
                                                                                                                                onclick="window.location = '#';">Trending<b
                                                                                                                                    class="fa fa-angle-right"></b></a>
                                                                                                                            <ul>
                                                                                                                                <li><a href="#"
                                                                                                                                        onclick="window.location = '#';">Punge
                                                                                                                                        nenune</a>
                                                                                                                                </li>
                                                                                                                            </ul>
                                                                                                                        </li>
                                                                        ...
                                                                        <li class="item-vertical">
                                                                            ...
                                                                            <a href="#" class="clearfix">
                                                                                <span>
                                                                                    <strong><img
                                                                                            src="{{ asset('public') }}/image/catalog/demo/menu/icon/icon-9.png"
                                                                                            alt="">Real House</strong>
                                                                                </span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="item-vertical">
                                                                        ...
                                                                        <li class="item-vertical">
                                                                            ...
                                                                            <a href="#" class="clearfix">
                                                                                <span>
                                                                                    <strong><img
                                                                                            src="{{ asset('public') }}/image/catalog/demo/menu/icon/icon-7.png"
                                                                                            alt="">Food &amp;
                                                                                        Restaurant</strong>
                                                                                </span>
                                                                            </a>
                                                                        ...
                                                                        <li class="loadmore"><i
                                                                                ...
                                                                                class="more-view"> More Categories</span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="megamenu-pattern">
                                                                <div class="container">
                                                                    <ul class="megamenu" data-transition="slide"
                                                                                            ...
                                                                                            <div class="html ">
                                                                                                <div class="col-lg-4 col-md-4 col-sm-12"
                                                                                                    ...
                                                                                                    <a href="index.html"
                                                                                                        ...
                                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/menu/feature/layout1.jpg"
                                                                                                            alt="layout"
                                                                                                ...
                                                                                                <div class="col-lg-4 col-md-4 col-sm-12"
                                                                                                    ...
                                                                                                    <a href="home2.html"
                                                                                                        title=""
                                                                                                        style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
                                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/menu/feature/layout2.jpg"
                                                                                                            alt="layout"
                                                                                                            style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
                                                                                                        <p>Home Page 2 </p>
                                                                                                    </a>
                                                                                                ...
                                                                                                <div class="col-lg-4 col-md-4 col-sm-12"
                                                                                                    ...
                                                                                                    <a href="home3.html"
                                                                                                        title=""
                                                                                                        style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
                                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/menu/feature/layout3.jpg"
                                                                                                            alt="layout"
                                                                                                            style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
                                                                                                        <p>Home Page 3 </p>
                                                                                                    </a>
                                                                                                ...
                                                                                                <div class="col-lg-4 col-md-4 col-sm-12"
                                                                                                    ...
                                                                                                    <a href="home4.html"
                                                                                                        title=""
                                                                                                        style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
                                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/menu/feature/layout4.jpg"
                                                                                                            alt="layout"
                                                                                                            style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
                                                                                                        <p>Home Page 4 </p>
                                                                                                    </a>
                                                                                                ...
                                                                                                <div class="col-lg-4 col-md-4 col-sm-12"
                                                                                                    ...
                                                                                                    <a href="home5.html"
                                                                                                        title=""
                                                                                                        style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
                                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/menu/feature/layout5.jpg"
                                                                                                            alt="layout"
                                                                                                            style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
                                                                                                        <p>Home Page 5 </p>
                                                                                                    </a>
                                                                                                ...
                                                                                                <div class="col-lg-4 col-md-4 col-sm-12"
                                                                                                    ...
                                                                                                    <a href="home6.html"
                                                                                                        title=""
                                                                                                        style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
                                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/menu/feature/layout6.jpg"
                                                                                                            alt="layout"
                                                                                                            style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
                                                                                                        <p>Home Page 6 </p>
                                                                                                    </a>
                                                                                                        ...
                                                                                                        <div class="column">
                                                                                                            ...
                                                                                                            <div>
                                                                                                                <ul
                                                                                                                    ...
                                                                                                                    <li><a
                                                                                                                            href="category-v2.html">Category
                                                                                                                            Page
                                                                                                                            2</a>
                                                                                                                    </li>
                                                                                                                    <li><a
                                                                                                                            href="category-v3.html">Category
                                                                                                                            Page
                                                                                                                            3</a>
                                                                                                                    </li>
                                                                                                                </ul>
                                                                                                        ...
                                                                                                        <div class="column">
                                                                                                            ...
                                                                                                            <div>
                                                                                                                <ul
                                                                                                                    class="row-list">
                                                                                                                    <li><a
                                                                                                                            href="product.html">Image
                                                                                                                            size
                                                                                                                            -
                                                                                                                            small</a>
                                                                                                                    </li>
                                                                                                                    <li><a
                                                                                                                            href="product-v2.html">Image
                                                                                                                            size
                                                                                                                            -
                                                                                                                            medium</a>
                                                                                                                    </li>
                                                                                                                    <li><a
                                                                                                                            href="product-v3.html">Image
                                                                                                                            size
                                                                                                                            -
                                                                                                                            big</a>
                                                                                                                    </li>
                                                                        ...
                                                                        <li
                                                                            class="item-style1 content-full with-sub-menu hover">
                                                                            <p class="close-menu"></p>
                                                                            <a class="clearfix">
                                                                                <strong>
                                                                                    Colections
                                                                            ...
                                                                            <div class="sub-menu"
                                                                                ...
                                                                                <div class="content">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-3">
                                                                                            <div class="link ">
                                                                                                <img src="{{ asset('public') }}/image/catalog/demo/menu/menu-img1.jpg"
                                                                                                    alt=""
                                                                                                    style="width: 100%;">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-sm-3">
                                                                                            <div class="link ">
                                                                                                <img src="{{ asset('public') }}/image/catalog/demo/menu/menu-img2.jpg"
                                                                                                    alt=""
                                                                                                    style="width: 100%;">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-sm-3">
                                                                                            <div class="link ">
                                                                                                <img src="{{ asset('public') }}/image/catalog/demo/menu/menu-img3.jpg"
                                                                                                    alt=""
                                                                                                    style="width: 100%;">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-sm-3">
                                                                                            <div class="link ">
                                                                                                <img src="{{ asset('public') }}/image/catalog/demo/menu/menu-img4.jpg"
                                                                                                    alt=""
                                                                                                    style="width: 100%;">
                                                                                            </div>
                                                                                        </div>
                                                                                                            ...
                                                                                                            <ul>
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Fashion</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Trending</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Macs</a>
                                                                                                                        </li>
                                                                                                                    </ul>
                                                                                                                </li>
                                                                                                            </ul>
                                                                                                            ...
                                                                                                            <ul>
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Destinations</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Camera
                                                                                                                                New</a>
                                                                                                            ...
                                                                                                            <ul>
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Men
                                                                                                                                Fashion</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Knage
                                                                                                                                unget</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Qunge
                                                                                                                                genga</a>
                                                                                                                        </li>
                                                                                                                    </ul>
                                                                                                                </li>
                                                                                                            ...
                                                                                                            <ul>
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Windows</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Pearl
                                                                                                                                mens</a>
                                                                            ...
                                                                            <div class="sub-menu" style="width: 100%">
                                                                                <div class="content">
                                                                                    <div class="row">
                                                                                                            ...
                                                                                                            <ul>
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Latenge
                                                                                                                                mange</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Punge
                                                                                                                ...
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Laptops
                                                                                                                                &amp;
                                                                                                                                Notebooks</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Kitchen</a>
                                                                                                                        </li>
                                                                                                                    </ul>
                                                                                                                </li>
                                                                                                            </ul>
                                                                                                            ...
                                                                                                            <ul>
                                                                                                                ...
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Necklaces</a>
                                                                                                                        </li>
                                                                                                                        <li><a href="#"
                                                                                                                                onclick="window.location = '#';">Tange
                                                                                                                                manue</a>
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <div
                                                                                                class="product best-sellers-menu">
                                                                                                <div class="image">
                                                                                                    <a href="#"
                                                                                                        onclick="window.location = '#'"><img
                                                                                                            src="{{ asset('public') }}/image/catalog/demo/product/fashion/24.png"
                                                                                                            alt=""></a>
                                                                                                </div>
                                                                                                <div class="name"><a
                                                                                                        href="#"
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <ul class="row-list">
                                                                                                ...
                                                                                                <li><a class="subcategory_item"
                                                                                                        ...
                                                                                                        Us 2</a></li>
                                                                                                <li><a class="subcategory_item"
                                                                                                        href="about-us-3.html">About
                                                                                                        Us 3</a></li>
                                                                                                <li><a class="subcategory_item"
                                                                                                        href="about-us-4.html">About
                                                                                                        Us 4</a></li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                                                                        ...
                                                                        <li class="deal-h5 hidden">
                                                                            ...
                                                                            <a href="#" class="clearfix">
                                                                                <strong>
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/menu/hot-block.png"
                                                                                        alt="">Buy This Theme!
                                                                                </strong>
                                                                            </a>
                                                                        </li>
                    ...
                    <div class="container page-builder-ltr">
                        <div class="row row_sxc8 row-style">
                                            ...
                                            <div class="so-homeslider yt-content-slider full_slider owl-drag" data-rtl="yes"
                                                ...
                                                <div class="item">
                                                    <a href=" #   " title="slide 6 - 1" target="_self">
                                                        <img class="responsive"
                                                            src="{{ asset('public') }}/image/catalog/demo/slider/home6/slider-31.jpg"
                                                            alt="slide 6 - 1">
                                                    </a>
                                                ...
                                                <div class="item">
                                                    <a href=" #   " title="slide 6 - 2" target="_self">
                                                        <img class="responsive"
                                                            src="{{ asset('public') }}/image/catalog/demo/slider/home6/slider-32.jpg"
                                                            alt="slide 6 - 2">
                                                    </a>
                                                    <div class="sohomeslider-description">
                                                    </div>
                                                ...
                                                <div class="item">
                                                    <a href=" #   " title="slide 6 - 3" target="_self">
                                                        <img class="responsive"
                                                            src="{{ asset('public') }}/image/catalog/demo/slider/home6/slider-33.jpg"
                                                            alt="slide 6 - 3">
                                                    </a>
                                                    <div class="sohomeslider-description">
                                                    </div>
                                                ...
                                                <div class="item">
                                                    <a href=" #   " title="slide 6 - 4" target="_self">
                                                        <img class="responsive"
                                                            src="{{ asset('public') }}/image/catalog/demo/slider/home6/slider-34.jpg"
                                                            alt="slide 6 - 4">
                                                    </a>
                                                    <div class="sohomeslider-description">
                                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col_mdsk col-style">
                                <div class="banner-layout-2 h6-banner-1 clearfix">
                                    <div class="banner-1 banners">
                                        <div>
                                            <a href="#" title="Banner 2">
                                                <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/home6_1.jpg" alt="Static Image">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="banner-2 banners">
                                        <div>
                                            <a href="#" title="Banner 2">
                                                <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/home6_2.jpg" alt="Static Image">
                                            </a>
                                        </div>
                                    ...
                                    <div class="banner-3 banners">
                                        <div>
                                            <a href="#" title="Banner 2">
                                                <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/home6_4.jpg" alt="Static Image">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="banner-4 banners">
                                        <div>
                                            <a href="#" title="Banner 2">
                                                <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/home6_3.jpg" alt="Static Image">
                                            </a>
                                        </div>
                                    ...
                                    <div class="banner-5 banners">
                                        <div>
                                            <a href="#" title="Banner 2">
                                                <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/home6_6.jpg" alt="Static Image">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="banner-6 banners">
                                        <div>
                                            <a href="#" title="Banner 2">
                                                <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/home6_5.jpg" alt="Static Image">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_stzj block">
                                <div class="cate-html">
                                    <ul class="cate-html-item contentslider" data-rtl="no" data-loop="no"
                                        data-autoplay="yes" data-autoheight="no" data-autowidth="no" data-delay="4"
                                        data-speed="0.6" data-margin="27" data-items_column0="6" data-items_column1="4"
                                        data-items_column2="3" data-items_column3="3" data-items_column4="2"
                                        data-arrows="yes" data-pagination="no" data-lazyload="no" data-hoverpause="yes">
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img
                                                        src="{{ asset('public') }}/image/catalog/demo/banners/home3/cate-1.jpg"
                                        ...
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img
                                                        src="{{ asset('public') }}/image/catalog/demo/banners/home3/cate-2.jpg"
                                                        alt="Static Image"></a></div>
                                            <div class="item-content">
                                        ...
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img
                                                        src="{{ asset('public') }}/image/catalog/demo/banners/home3/cate-3.jpg"
                                                        alt="Static Image"></a></div>
                                            <div class="item-content">
                                        ...
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img
                                                        src="{{ asset('public') }}/image/catalog/demo/banners/home3/cate-4.jpg"
                                                        alt="Static Image"></a></div>
                                            <div class="item-content">
                                        ...
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img
                                                        src="{{ asset('public') }}/image/catalog/demo/banners/home3/cate-5.jpg"
                                                        alt="Static Image"></a></div>
                                            <div class="item-content">
                                                <h4><a href="#">Health Care</a></h4>
                                            </div>
                                        ...
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img
                                                        src="{{ asset('public') }}/image/catalog/demo/banners/home3/cate-6.jpg"
                                                        alt="Static Image"></a></div>
                                            <div class="item-content">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_1x14">
                                            <div class="qr-code-block block">
                                                <div class="item-image">
                                                    <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/qr.png" alt="" width="65"
                                                        height="65">
                                                </div>
                                                <div class="item-content">
                                            ...
                                            <div class="module so-extraslider-ltr home3_extra bn-shadow">
                                                ...
                                                <div class="modcontent">
                                                    <div id="so_extra_slider_450"
                                                        ...
                                                        <div class="extraslider-inner products-list grid"
                                                            data-effect="none">
                                                            <div class="item ">
                                                                <div class="item-wrap product-layout style1 ">
                                                                    <div class="product-item-container">
                                                                        <div class="left-block ">
                                                                            <div
                                                                                class="product-image-container so-quickview">
                                                                                <a class="lt-image" href="product.html"
                                                                                    target="_blank"
                                                                                    title="Pariatur beef desktop publishing package..">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/5-60x60.png"
                                                                        ...
                                                                        <div class="right-block">
                                                                            <div class="caption">
                                                                                ...
                                                                                <div class="content_price price font-ct">
                                                                                    <span
                                                                                        class="old-price product-price">$45.00
                                                                                    </span>&nbsp;&nbsp;
                                                                                    <span class="price-old">$50.00
                                                                                    </span>&nbsp;
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="product-item-container">
                                                                        <div class="left-block ">
                                                                            <div
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    ...
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/15-60x60.png"
                                                                        ...
                                                                        <div class="right-block">
                                                                            <div class="caption">
                                                                                ...
                                                                                <div class="content_price price font-ct">
                                                                                    <span
                                                                                        class="old-price product-price">$50.00
                                                                                    </span>&nbsp;&nbsp;
                                                                                    <span class="price-old">$279.99
                                                                                    </span>&nbsp;
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    ...
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/21-60x60.png"
                                                                            ...
                                                                            <div class="caption">
                                                                                <h4 class="font-ct">
                                                                                    <a href="product.html" target="_blank"
                                                                                        ...
                                                                                        Maciti Aliqua occur that pleasures
                                                                                        have ..
                                                                                    </a>
                                                                                </h4>
                                                                                <div class="content_price price font-ct">
                                                                                    <span
                                                                                        class="old-price product-price">$60.00
                                                                                    </span>&nbsp;&nbsp;
                                                                    ...
                                                                    <div class="product-item-container">
                                                                        <div class="left-block ">
                                                                            <div
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    target="_blank"
                                                                                    title="Est Officia Including Shoes Beautiful Pi..">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/24-60x60.png"
                                                                                        alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                                </a>
                                                                            </div>
                                                                            <div class="box-label">
                                                                        ...
                                                                        <div class="right-block">
                                                                            <div class="caption">
                                                                                ...
                                                                                <div class="content_price price font-ct">
                                                                                    <span
                                                                                        class="old-price product-price">$80.00
                                                                                    </span>&nbsp;&nbsp;
                                                                                    <span class="price-old">$100.00
                                                                                    </span>&nbsp;
                                                                                </div>
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    ...
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/14-60x60.png"
                                                                            ...
                                                                            <div class="caption">
                                                                                <h4 class="font-ct">
                                                                                    <a href="product.html" target="_blank"
                                                                                        ...
                                                                                        Ligula tortoram ut labore et dolore
                                                                                        magn..
                                                                                    </a>
                                                                                </h4>
                                                                                <div class="content_price price font-ct">
                                                                    ...
                                                                    <div class="product-item-container">
                                                                        <div class="left-block ">
                                                                            <div
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    ...
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/10-60x60.jpg"
                                                                        ...
                                                                        <div class="right-block">
                                                                            <div class="caption">
                                                                                ...
                                                                                <div class="content_price price font-ct">
                                                                                    <span
                                                                                        class="old-price product-price">$89.00
                                                                                    </span>&nbsp;&nbsp;
                                                                                    <span class="price-old">$100.00
                                                                                    </span>&nbsp;
                                                                                </div>
                                            ...
                                            <div class="banner-layout-3 bt-1 clearfix banners">
                                                <div class="">
                                                    <a class="bn-shadow" href="#" title="Banner 1">
                                                        <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/01.jpg"
                                                            alt="Static Image">
                                                    </a>
                                                </div>
                                            </div>
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    ...
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/25-210x210.jpg"
                                                                                        alt="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                                                                                </a>
                                                                            </div>
                                                                            <div class="box-label">
                                                                                <span class="label-product label-sale">-82%
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="right-block">
                                                                            <div class="caption">
                                                                                <h4 class="font-ct">
                                                                                    <a href="product.html" target="_self"
                                                                                        title="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2) ">
                                                                                        Toshiba Pro 21&quot;(21:9) FHD IPS
                                                                                        LED 1920X1080 HDMI(2)
                                                                                    </a>
                                                                                </h4>
                                                                                <div class="content_price price font-ct">
                                                                                    <span
                                                                            ...
                                                                            <div class="button-group2">
                                                                                <button class="bt-cart addToCart"
                                                                                    ...
                                                                                    title="Add to Cart"
                                                                                    onclick="cart.add('104');"> <span>Add to
                                                                                        Cart</span></button>
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    ...
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/19-210x210.jpg"
                                                                                        alt="Compact Portable Charger (Power Bank) with Premium">
                                                                                </a>
                                                                            </div>
                                                                            <div class="box-label">
                                                                                <span class="label-product label-sale">-70%
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="right-block">
                                                                            <div class="caption">
                                                                                <h4 class="font-ct">
                                                                                    <a href="product.html" target="_self"
                                                                                        title="Compact Portable Charger (Power Bank) with Premium ">
                                                                                        Compact Portable Charger (Power
                                                                                        Bank) with Premium
                                                                                    </a>
                                                                                </h4>
                                                                                <div class="content_price price font-ct">
                                                                            ...
                                                                            <div class="button-group2">
                                                                                <button class="bt-cart addToCart"
                                                                                    type="button" data-toggle="tooltip"
                                                                                    title="Add to Cart"
                                                                                    onclick="cart.add('66');"> <span>Add to
                                                                                        Cart</span></button>
                                                                                <button class="bt wishlist" type="button"
                                                                                    data-toggle="tooltip"
                                                                                    title="Add to Wish List"
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    ...
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/4-210x210.jpg"
                                                                                        alt="Portable  Compact Charger (External Battery) t45">
                                                                                </a>
                                                                            </div>
                                                                            <div class="box-label">
                                                                                <span class="label-product label-sale">-40%
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="right-block">
                                                                            <div class="caption">
                                                                                <h4 class="font-ct">
                                                                                    <a href="product.html" target="_self"
                                                                                        title="Portable  Compact Charger (External Battery) t45 ">
                                                                                        Portable Compact Charger (External
                                                                                        Battery) t45
                                                                                    </a>
                                                                                </h4>
                                                                                <div class="content_price price font-ct">
                                                                            ...
                                                                            <div class="button-group2">
                                                                                <button class="bt-cart addToCart"
                                                                                    type="button" data-toggle="tooltip"
                                                                                    title="Add to Cart"
                                                                                    onclick="cart.add('78');"> <span>Add to
                                                                                        Cart</span></button>
                                                                                <button class="bt wishlist" type="button"
                                                                                    data-toggle="tooltip"
                                                                                    title="Add to Wish List"
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    ...
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/1-210x210.png"
                                                                                        alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus">
                                                                                </a>
                                                                            </div>
                                                                            <div class="box-label">
                                                                                <span class="label-product label-sale">-20%
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="right-block">
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    ...
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/11-210x210.jpg"
                                                                        ...
                                                                        <div class="right-block">
                                                                            ...
                                                                            <div class="button-group2">
                                                                                <button class="bt-cart addToCart"
                                                                                    type="button" data-toggle="tooltip"
                                                                                    title="Add to Cart"
                                                                                    onclick="cart.add('51');"> <span>Add to
                                                                                        Cart</span></button>
                                                                                <button class="bt wishlist" type="button"
                                                                                    data-toggle="tooltip"
                                                                                    title="Add to Wish List"
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    ...
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/13-210x210.jpg"
                                                                        ...
                                                                        <div class="right-block">
                                                                            ...
                                                                            <div class="button-group2">
                                                                                <button class="bt-cart addToCart"
                                                                                    type="button" data-toggle="tooltip"
                                                                                    title="Add to Cart"
                                                                                    onclick="cart.add('103');"> <span>Add to
                                                                                        Cart</span></button>
                                                                                <button class="bt wishlist" type="button"
                                                                                    data-toggle="tooltip"
                                                                                    title="Add to Wish List"
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_dmsm block">
                                            <div class="block-testimonial bn-shadow">
                                                <div class="testimonial-items contentslider" data-rtl="no" data-loop="no"
                                                    data-autoplay="yes" data-autoheight="no" data-autowidth="no"
                                                    ...
                                                    <div class="item">
                                                        <div class="text">
                                                            <div class="t">Lorem Khaled Ipsum is a major key to success.
                                                                It’s on you how you want to live your life. Everyone has a
                                                                choice. I pick my choice, squeaky clean. Always remember in
                                                                the jungle there’s a lot of they in there</div>
                                                        </div>
                                                        <div class="img"><img
                                                                src="{{ asset('public') }}/image/catalog/demo/banners/home3/user-2.jpg"
                                                    ...
                                                    <div class="item">
                                                        <div class="text">
                                                            <div class="t">
                                                                Khaled Lorem Ipsum is a major key to success. It’s on you
                                                                how you want to live your life. Everyone has a choice. I
                                                                pick my choice, squeaky clean. Always remember in the jungle
                                                                there’s a lot of they in there
                                                            </div>
                                                        </div>
                                                        <div class="img"><img
                                                                src="{{ asset('public') }}/image/catalog/demo/banners/home3/user-1.jpg"
                                                                alt="Static Image"></div>
                                                    ...
                                                    <div class="item">
                                                        <div class="text">
                                                            <div class="t">
                                                                Lorem Khaled Ipsum is a major key to success. It’s on you
                                                                how you want to live your life. Everyone has a choice. I
                                                                pick my choice, squeaky clean. Always remember in the jungle
                                                                there’s a lot of they in there
                                                            </div>
                                                        ...
                                                        <div class="img"><img
                                                                src="{{ asset('public') }}/image/catalog/demo/banners/home3/user-3.jpg"
                                                                alt="Static Image"></div>
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div class="product-image-container">
                                                                                <div class="image so-quickview">
                                                                                    ...
                                                                                    <a class="lt-image" href="product.html"
                                                                                        target="_self">
                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/1-226x226.jpg"
                                                                                            alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus"
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div class="product-image-container">
                                                                                <div class="image so-quickview">
                                                                                    ...
                                                                                    <a class="lt-image" href="product.html"
                                                                                        target="_self">
                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/11-226x226.jpg"
                                                                                            alt="Charger  Compact Portable with Premium"
                                                                                            class="img-responsive">
                                                                                    </a>
                                                                                </div>
                                                                        ...
                                                                        <div class="right-block">
                                                                            <div class="caption">
                                                                                <h4><a href="product.html" target="_self"
                                                                                        ...
                                                                                        Compact Portable with Premium</a>
                                                                                </h4>
                                                                                <div class="rating">
                                                                                    <span class="fa fa-stack"><i
                                                                                            class="fa fa-star-o fa-stack-2x"></i></span>
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div class="product-image-container">
                                                                                <div class="image so-quickview">
                                                                                    ...
                                                                                    <a class="lt-image" href="product.html"
                                                                                        target="_self">
                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/26-226x226.jpg"
                                                                        ...
                                                                        <div class="right-block">
                                                                            ...
                                                                            <div class="button-group2">
                                                                                <button class="bt-cart addToCart"
                                                                                    type="button" data-toggle="tooltip"
                                                                                    title="Add to Cart"
                                                                                    onclick="cart.add('105');"> <span>Add to
                                                                                        Cart</span></button>
                                                                                <button class="bt wishlist" type="button"
                                                                                    data-toggle="tooltip"
                                                                                    title="Add to Wish List"
                                                                ...
                                                                <div class="transition product-layout">
                                                                    <div class="product-item-container ">
                                                                        <div class="left-block ">
                                                                            <div class="product-image-container">
                                                                                <div class="image so-quickview">
                                                                                    ...
                                                                                    <a class="lt-image" href="product.html"
                                                                                        target="_self">
                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/6-226x226.jpg"
                                                                        ...
                                                                        <div class="right-block">
                                                                            <div class="caption">
                                                                                <h4><a href="product.html" target="_self"
                                                                                        title="Mammo Diablo except to obtain some advan from">Mammo
                                                                                        Diablo except to obtain some advan
                                                                                        from</a></h4>
                                                                                <div class="rating">
                                                                                    <span class="fa fa-stack"><i
                                                                                            class="fa fa-star-o fa-stack-2x"></i></span>
                                                                            ...
                                                                            <div class="button-group2">
                                                                                <button class="bt-cart addToCart"
                                                                                    type="button" data-toggle="tooltip"
                                                                                    title="Add to Cart"
                                                                                    onclick="cart.add('110');"> <span>Add to
                                                                                        Cart</span></button>
                                                                                <button class="bt wishlist" type="button"
                                                                                    data-toggle="tooltip"
                                                                                    title="Add to Wish List"
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div class="product-image-container">
                                                                                <div class="image so-quickview">
                                                                                    ...
                                                                                    <a class="lt-image" href="product.html"
                                                                                        target="_self">
                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/29-226x226.jpg"
                                                                            ...
                                                                            <div class="box-label">
                                                                                <span
                                                                                    class="label-product label-sale">-11%</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="right-block">
                                                                            <div class="caption">
                                                                            ...
                                                                            <div class="button-group2">
                                                                                <button class="bt-cart addToCart"
                                                                                    type="button" data-toggle="tooltip"
                                                                                    title="Add to Cart"
                                                                                    onclick="cart.add('86');"> <span>Add to
                                                                                        Cart</span></button>
                                                                                <button class="bt wishlist" type="button"
                                                                                    data-toggle="tooltip"
                                                                                    title="Add to Wish List"
                                                                        ...
                                                                        <div class="left-block ">
                                                                            <div class="product-image-container">
                                                                                <div class="image so-quickview">
                                                                                    ...
                                                                                    <a class="lt-image" href="product.html"
                                                                                        target="_self">
                                                                                        <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/19-226x226.jpg"
                                                                                            alt="Compact Portable Charger (Power Bank) with Premium"
                                                                                            class="img-responsive">
                                                                                    </a>
                                                                                </div>
                                                                            ...
                                                                            <div class="box-label">
                                                                                <span
                                                                                    class="label-product label-sale">-70%</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="right-block">
                                                                            <div class="caption">
                                                                                <h4><a href="product.html" target="_self"
                                                                                        title="Compact Portable Charger (Power Bank) with Premium">Compact
                                                                                        Portable Charger (Power Bank) with
                                                                                        Premium</a></h4>
                                                                                <div class="rating">
                                                                                    <span class="fa fa-stack"><i
                                                                                            class="fa fa-star-o fa-stack-2x"></i></span>
                                            ...
                                            <div class="banner-21 banner">
                                                <div>
                                                    <a class="bn-shadow" href="#" title="Banner 24">
                                                        <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/banner21.jpg"
                                                            alt="Static Image">
                                                    </a>
                                                </div>
                                            </div>
                                                    ...
                                                    <div id="so_listing_tabs_342" class="so-listing-tabs first-load module">
                                                        <div class="ltabs-wrap products-list grid">
                                                            <div class="ltabs-tabs-container" data-delay="300"
                                                                ...
                                                                data-type_source="0" data-lg="2" data-md="2" data-sm="1"
                                                                data-xs="2" data-margin="0">
                                                                <!--Begin Tabs-->
                                                                    ...
                                                                    <div class="item-sub-cat">
                                                                        <ul class="ltabs-tabs cf">
                                                                            <li class="ltabs-tab tab-sel"
                                                                                data-category-id="30"
                                                                                data-active-content=".items-category-30">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/116.jpg"
                                                                                        title="Bags" alt="Bags"
                                                                            ...
                                                                            <li class="ltabs-tab" data-category-id="31"
                                                                                data-active-content=".items-category-31">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/23.jpg"
                                                                                        title="Dress Ladies"
                                                                                        alt="Dress Ladies"
                                                                                        style="background:#fff" />
                                                                                </div><span class="ltabs-tab-label">Dress
                                                                                    Ladies</span>
                                                                            </li>
                                                                            <li class="ltabs-tab " data-category-id="32"
                                                                                data-active-content=".items-category-32">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/24.jpg"
                                                                                        title="Jean" alt="Jean"
                                                                                        style="background:#fff" />
                                                                                </div>
                                                                                <span class="ltabs-tab-label">
                                                                            ...
                                                                            <li class="ltabs-tab " data-category-id="33"
                                                                                data-active-content=".items-category-33">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/9.jpg"
                                                                                        title="Men Fashion"
                                                                                        alt="Men Fashion"
                                                                                        style="background:#fff" />
                                                                                </div>
                                                                            ...
                                                                            <li class="ltabs-tab " data-category-id="34"
                                                                                data-active-content=".items-category-34">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/22.jpg"
                                                                            ...
                                                                            <li class="ltabs-tab " data-category-id="35"
                                                                                data-active-content=".items-category-35">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/25.jpg"
                                                                            ...
                                                                            <li class="ltabs-tab " data-category-id="36"
                                                                                data-active-content=".items-category-36">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/21.jpg"
                                                                                        title="Western Wear"
                                                                                        alt="Western Wear"
                                                                                        style="background:#fff" />
                                                                                </div>
                                                                            ...
                                                                            <li class="ltabs-tab " data-category-id="37"
                                                                                data-active-content=".items-category-37">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/10.jpg"
                                                                                        title="Women Fashion"
                                                                                        alt="Women Fashion"
                                                                                        style="background:#fff" />
                                                                                </div>
                                                            ...
                                                            <div class="wap-listing-tabs ">
                                                                <div class="ltabs-items-container">
                                                                    <div class="ltabs-items ltabs-items-selected items-category-30"
                                                                        data-total="8">
                                                                        <div class="ltabs-items-inner ltabs-slider">
                                                                            <div class="ltabs-item ">
                                                                                <div
                                                                                    class="item-inner product-thumb trg transition product-layout">
                                                                                    <div class="product-item-container">
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                class="image product-image-container so-quickview ">
                                                                                                <a class="lt-image"
                                                                                                    href="product.html"
                                                                                                    target="_self"
                                                                                                    title="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/24-226x226.png"
                                                                                                        alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/16-226x226.png"
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    target="_self"
                                                                                                    title="Ligula tortoram ut labore et dolore magna elip">
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/14-226x226.png"
                                                                                                        alt="Ligula tortoram ut labore et dolore magna elip">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                        ...
                                                                                        <div class="right-block">
                                                                                            ...
                                                                                            <div class="button-group2">
                                                                                                ...
                                                                                                <button class="bt wishlist"
                                                                                                    ...
                                                                                                    data-toggle="tooltip"
                                                                                                    title="Add to Wish List"
                                                                                                    onclick="wishlist.add('87');"><i
                                                                                                        class="fa fa-heart"></i></button>
                                                                                                <button class="bt compare"
                                                                                                    type="button"
                                                                                                    data-toggle="tooltip"
                                                                                                    title="Compare this Product"
                                                                                                    onclick="compare.add('87');"><i
                                                                                                        class="fa fa-exchange"></i></button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    target="_self"
                                                                                                    title="Ligula tortoram ut labore et dolore magna elip">
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/11-226x226.png"
                                                                                                        alt="Ligula tortoram ut labore et dolore magna elip">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                        ...
                                                                                        <div class="right-block">
                                                                                            ...
                                                                                            <div class="button-group2">
                                                                                                ...
                                                                                                <button class="bt wishlist"
                                                                                                    ...
                                                                                                    data-toggle="tooltip"
                                                                                                    title="Add to Wish List"
                                                                                                    onclick="wishlist.add('90');"><i
                                                                                                        class="fa fa-heart"></i></button>
                                                                                                <button class="bt compare"
                                                                                                    type="button"
                                                                                                    data-toggle="tooltip"
                                                                                                    title="Compare this Product"
                                                                                                    onclick="compare.add('90');"><i
                                                                                                        class="fa fa-exchange"></i></button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/18-226x226.png"
                                                                                                        alt="magna elip therefore always free from bolac sodo">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                                <span
                                                                                                    class="label-product label-sale">-2%</span>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="right-block">
                                                                                            <div class="caption">
                                                                                            ...
                                                                                            <div class="button-group2">
                                                                                                ...
                                                                                                <button class="bt wishlist"
                                                                                                    ...
                                                                                                    data-toggle="tooltip"
                                                                                                    title="Add to Wish List"
                                                                                                    onclick="wishlist.add('83');"><i
                                                                                                        class="fa fa-heart"></i></button>
                                                                                                <button class="bt compare"
                                                                                                    type="button"
                                                                                                    data-toggle="tooltip"
                                                                                                    title="Compare this Product"
                                                                                                    onclick="compare.add('83');"><i
                                                                                                        class="fa fa-exchange"></i></button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    target="_self"
                                                                                                    title="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/fashion/15-226x226.png"
                                                                                                        alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                                <span
                                                                                                    class="label-product label-sale">-82%</span>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="right-block">
                                                                                            <div class="caption">
                                                                    ...
                                                                    <div class="ltabs-items items-category-31 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-32 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-33 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-34 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-35 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-36 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-37 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="modcontent">
                                                    <div id="so_listing_tabs_727" class="so-listing-tabs first-load module">
                                                        <div class="ltabs-wrap">
                                                            <div class="ltabs-tabs-container" data-delay="300"
                                                                data-duration="600" data-effect="starwars" data-ajaxurl=""
                                                                data-type_source="0" data-lg="4" data-md="3" data-sm="2"
                                                                data-xs="2" data-margin="0">
                                                                <!--Begin Tabs-->
                                                                <div class="ltabs-tabs-wrap">
                                                                    <span class="ltabs-tab-selected"></span>
                                                                    ...
                                                                    <div class="item-sub-cat">
                                                                        <ul class="ltabs-tabs cf">
                                                                            <li class="ltabs-tab tab-sel"
                                                                                data-category-id="40"
                                                                                data-active-content=".items-category-40">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/94.jpg"
                                                                                        title="CASE" alt="CASE"
                                                                                        style="background:#fff" />
                                                                                </div>
                                                                                <span class="ltabs-tab-label">
                                                                            ...
                                                                            <li class="ltabs-tab " data-category-id="41"
                                                                                data-active-content=".items-category-41">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/93.jpg"
                                                                                        title="Cell & Cable"
                                                                                        alt="Cell & Cable"
                                                                                        style="background:#fff" />
                                                                                </div><span class="ltabs-tab-label">Cell &
                                                                                    Cable</span>
                                                                            </li>
                                                                            <li class="ltabs-tab " data-category-id="42"
                                                                                data-active-content=".items-category-42">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/88.jpg"
                                                                            ...
                                                                            <li class="ltabs-tab " data-category-id="43"
                                                                                data-active-content=".items-category-43">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/90.jpg"
                                                                            ...
                                                                            <li class="ltabs-tab " data-category-id="44"
                                                                                data-active-content=".items-category-44">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/87.jpg"
                                                                                        title="Mobile & Table"
                                                                                        alt="Mobile & Table"
                                                                                        style="background:#fff" />
                                                                                </div>
                                                                            ...
                                                                            <li class="ltabs-tab " data-category-id="45"
                                                                                data-active-content=".items-category-45">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/91.jpg"
                                                                            ...
                                                                            <li class="ltabs-tab " data-category-id="46"
                                                                                data-active-content=".items-category-46">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/89.jpg"
                                                                            ...
                                                                            <li class="ltabs-tab " data-category-id="47"
                                                                                data-active-content=".items-category-47">
                                                                                <div class="ltabs-tab-img">
                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/category/92.jpg"
                                                                                        title="Video & Camera"
                                                                                        alt="Video & Camera"
                                                                                        style="background:#fff" />
                                                                                </div>
                                                            ...
                                                            <div class="wap-listing-tabs products-list grid">
                                                                <div class="ltabs-items-container">
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    target="_self"
                                                                                                    title="Compact Portable Charger (External Battery)">
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/13-270x270.jpg"
                                                                                                        alt="Compact Portable Charger (External Battery)">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    target="_self"
                                                                                                    title="Charger  Compact Portable with Premium">
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/11-270x270.jpg"
                                                                                                        alt="Charger  Compact Portable with Premium">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/14-270x270.jpg"
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/21-270x270.jpg"
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    target="_self"
                                                                                                    title="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/26-270x270.jpg"
                                                                                                        alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    target="_self"
                                                                                                    title="Mammo Diablo except to obtain some advan from">
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/6-270x270.jpg"
                                                                                                        alt="Mammo Diablo except to obtain some advan from">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    target="_self"
                                                                                                    title="Portable  Compact Charger (External Battery) t45">
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/4-270x270.jpg"
                                                                                                        alt="Portable  Compact Charger (External Battery) t45">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                                <span
                                                                                                    class="label-product label-sale">-40%</span>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="right-block">
                                                                                            <div class="caption">
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/28-270x270.jpg"
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    target="_self"
                                                                                                    title="Compact Portable Charger (Power Bank) with Premium">
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/19-270x270.jpg"
                                                                                                        alt="Compact Portable Charger (Power Bank) with Premium">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/5-270x270.jpg"
                                                                                    ...
                                                                                    <div class="product-item-container">
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/9-270x270.jpg"
                                                                                                        alt="Luma Extrem ich toil and pain can pcure him">
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="box-label">
                                                                                                <span
                                                                                        ...
                                                                                        <div class="right-block">
                                                                                            <div class="caption">
                                                                                                ...
                                                                                                <p class="price">
                                                                                                    <span
                                                                                                        class="price-new">$400.00</span>
                                                                                                    <span
                                                                                                        class="price-old">$500.00</span>
                                                                                                </p>
                                                                                            </div>
                                                                                            <div class="button-group2">
                                                                                                <button
                                                                                        ...
                                                                                        <div class="left-block ">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="lt-image"
                                                                                                    ...
                                                                                                    <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/17-270x270.jpg"
                                                                                        ...
                                                                                        <div class="right-block">
                                                                                            ...
                                                                                            <div class="button-group2">
                                                                                                ...
                                                                                                <button class="bt wishlist"
                                                                                                    ...
                                                                                                    data-toggle="tooltip"
                                                                                                    title="Add to Wish List"
                                                                                                    onclick="wishlist.add('68');"><i
                                                                                                        class="fa fa-heart"></i></button>
                                                                                                <button class="bt compare"
                                                                                                    type="button"
                                                                                                    data-toggle="tooltip"
                                                                                                    title="Compare this Product"
                                                                                                    onclick="compare.add('68');"><i
                                                                                                        class="fa fa-exchange"></i></button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="ltabs-items items-category-41 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-42 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-43 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-44 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-45 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-46 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                    <div class="ltabs-items items-category-47 grid"
                                                                        data-total="8">
                                                                        <div class="ltabs-loading"></div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_4kdf block">
                                            <div class="banner-layout-5 row clearfix">
                                                <div class="banner-22 col-sm-4  banners">
                                                    <div>
                                                        <a class="bn-shadow" href="#" title="Banner 22">
                                                            <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/banner22.jpg"
                                                                alt="Static Image">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="banner-23 col-sm-4 banners">
                                                    <div>
                                                        <a class="bn-shadow" href="#" title="Banner 23">
                                                            <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/banner23.jpg"
                                                                alt="Static Image">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="banner-24 col-sm-4  banners">
                                                    <div>
                                                        <a class="bn-shadow" href="#" title="Banner 24">
                                                            <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/banner24.jpg"
                                                                alt="Static Image">
                                                        </a>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="product-item-container">
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            target="_self"
                                                                            title="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/25-234x234.jpg"
                                                                                alt="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                                ...
                                                                <div class="right-block">
                                                                    <div class="caption">
                                                                        ...
                                                                        <div class="content_price price font-ct">
                                                                            <span class="old-price product-price">$50.00
                                                                            </span>&nbsp;&nbsp;
                                                            ...
                                                            <div class="product-item-container">
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            target="_self"
                                                                            title="Compact Portable Charger (Power Bank) with Premium">
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/19-234x234.jpg"
                                                                                alt="Compact Portable Charger (Power Bank) with Premium">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                                ...
                                                                <div class="right-block">
                                                                    <div class="caption">
                                                                        ...
                                                                        <div class="content_price price font-ct">
                                                                            <span class="old-price product-price">$60.00
                                                                            </span>&nbsp;&nbsp;
                                                                            <span class="price-old">$199.99 </span>&nbsp;
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            target="_self"
                                                                            title="Portable  Compact Charger (External Battery) t45">
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/4-234x234.jpg"
                                                                                alt="Portable  Compact Charger (External Battery) t45">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                                ...
                                                                <div class="right-block">
                                                                    <div class="caption">
                                                                        <h4 class="font-ct">
                                                                            <a href="product.html" target="_self"
                                                                                title="Portable  Compact Charger (External Battery) t45 ">
                                                                                Portable Compact Charger (External Battery)
                                                                                t45
                                                                            </a>
                                                                        </h4>
                                                                        <div class="rating">
                                                                ...
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            target="_self"
                                                                            title=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus">
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/1-234x234.jpg"
                                                                                alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                                ...
                                                                <div class="right-block">
                                                                    <div class="caption">
                                                                        <h4 class="font-ct">
                                                                            <a href="product.html" target="_self"
                                                                                title=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus ">
                                                                                Magnetic Air Vent Phone Holder for iPhone 7
                                                                                / 7 Plus
                                                                            </a>
                                                                        </h4>
                                                                        <div class="rating">
                                                                        ...
                                                                        <div class="content_price price font-ct">
                                                                            <span class="old-price product-price">$80.00
                                                                            </span>&nbsp;&nbsp;
                                                                            <span class="price-old">$100.00 </span>&nbsp;
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            target="_self"
                                                                            title="Charger  Compact Portable with Premium">
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/11-234x234.jpg"
                                                                                alt="Charger  Compact Portable with Premium">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                                ...
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            target="_self"
                                                                            title="Compact Portable Charger (External Battery)">
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/13-234x234.jpg"
                                                                                alt="Compact Portable Charger (External Battery)">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                            ...
                                                            <div class="product-item-container">
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            target="_self"
                                                                            title="Compact Portable Charger (External Battery) T22">
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/21-234x234.jpg"
                                                                                alt="Compact Portable Charger (External Battery) T22">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                                ...
                                                                <div class="right-block">
                                                                    ...
                                                                    <div class="button-group2">
                                                                        <button class="bt-cart addToCart" type="button"
                                                                            data-toggle="tooltip" title="Add to Cart"
                                                                            onclick="cart.add('88');"> <span>Add to
                                                                                Cart</span></button>
                                                                        <button class="bt wishlist" type="button"
                                                                            data-toggle="tooltip" title="Add to Wish List"
                                                                            onclick="wishlist.add('88');"><i
                                                                ...
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            target="_self"
                                                                            title="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/26-234x234.jpg"
                                                                                alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                                ...
                                                                <div class="right-block">
                                                                    <div class="caption">
                                                                        <h4 class="font-ct">
                                                                            <a href="product.html" target="_self"
                                                                                title="Lorem Ipsum dolor at vero eos et iusto odi  with Premium ">
                                                                                Lorem Ipsum dolor at vero eos et iusto odi
                                                                                with Premium
                                                                            </a>
                                                                        </h4>
                                                                        <div class="rating">
                                                                ...
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            target="_self"
                                                                            title="Mammo Diablo except to obtain some advan from">
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/6-234x234.jpg"
                                                                                alt="Mammo Diablo except to obtain some advan from">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                            ...
                                                            <div class="product-item-container">
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            target="_self"
                                                                            title="Seneo PA046 Fast Charger  Wireless Sleep-Friendly)">
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/29-234x234.jpg"
                                                                                alt="Seneo PA046 Fast Charger  Wireless Sleep-Friendly)">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                                ...
                                                                <div class="right-block">
                                                                    <div class="caption">
                                                                        ...
                                                                        <div class="content_price price font-ct">
                                                                            <span class="old-price product-price">$89.00
                                                                            </span>&nbsp;&nbsp;
                                                                            <span class="price-old">$100.00 </span>&nbsp;
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="product-item-container">
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            target="_self"
                                                                            title="Compact Portable Charger (External Battery) T21">
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/14-234x234.jpg"
                                                                                alt="Compact Portable Charger (External Battery) T21">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                                ...
                                                                <div class="right-block">
                                                                    ...
                                                                    <div class="button-group2">
                                                                        <button class="bt-cart addToCart" type="button"
                                                                            data-toggle="tooltip" title="Add to Cart"
                                                                            onclick="cart.add('75');"> <span>Add to
                                                                                Cart</span></button>
                                                                        <button class="bt wishlist" type="button"
                                                                            data-toggle="tooltip" title="Add to Wish List"
                                                                            onclick="wishlist.add('75');"><i
                                                                ...
                                                                <div class="left-block ">
                                                                    <div class="product-image-container so-quickview">
                                                                        <a class="lt-image" href="product.html"
                                                                            ...
                                                                            <img src="{{ asset('public') }}/image/catalog/demo/product/electronic/20-234x234.jpg"
                                                                                alt="True Wireless Stereo Bluetooth 4.2 Headphones">
                                                                        </a>
                                                                    </div>
                                                                    <div class="box-label">
                                                                    </div>
                                                                ...
                                                                <div class="right-block">
                                                                    <div class="caption">
                                                                        <h4 class="font-ct">
                                                                            <a href="product.html" target="_self"
                                                                                title="True Wireless Stereo Bluetooth 4.2 Headphones ">
                                                                                True Wireless Stereo Bluetooth 4.2
                                                                                Headphones
                                                                            </a>
                                                                        </h4>
                                                                        <div class="rating">
                                                                    ...
                                                                    <div class="button-group2">
                                                                        <button class="bt-cart addToCart" type="button"
                                                                            data-toggle="tooltip" title="Add to Cart"
                                                                            onclick="cart.add('95');"> <span>Add to
                                                                                Cart</span></button>
                                                                        <button class="bt wishlist" type="button"
                                                                            data-toggle="tooltip" title="Add to Wish List"
                                                                            onclick="wishlist.add('95');"><i
                                                                                class="fa fa-heart"></i></button>
                                                                        <button class="bt compare" type="button"
                                                                            data-toggle="tooltip"
                                                                            title="Compare this Product"
                                                                            onclick="compare.add('95');"><i
                                                                                class="fa fa-exchange"></i></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="banner-25 col-sm-6 banners">
                                            <div>
                                                <a class="bn-shadow" href="#" title="Banner 25">
                                                    <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/banner25.jpg"
                                                        alt="Static Image">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="banner-26 col-sm-6  banners">
                                            <div>
                                                <a class="bn-shadow" href="#" title="Banner 26">
                                                    <img src="{{ asset('public') }}/image/catalog/demo/banners/home6/banner26.jpg"
                                                        alt="Static Image">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12 col_sa3f  col-style">
                                        <div class="footer-links">
                                            ...
                                            <ul class="links">
                                                ...
                                                <li>
                                                    <a title="Warranty And Services" href="warranty.html">Warranty And
                                                        Services</a>
                                                </li>
                                                <li>
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12 col_asli  col-style">
                                        <div class="footer-links">
                                            ...
                                            <ul class="links">
                                                ...
                                                <li>
                                                    <a title="Gift Certificates" href="gift-voucher.html">Gift
                                                        Certificates</a>
                                                </li>
                                                <li>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-5 paymen">
                                <img src="{{ asset('public') }}/image/catalog/demo/payment/payments-1.png" alt="imgpayment">
                            </div>
                        </div>
                    </div>
                </div>
