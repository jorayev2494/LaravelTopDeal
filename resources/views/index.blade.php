...
<body class="common-home ltr layout-6">
                                            ...
                                            <form action="#" method="post" enctype="multipart/form-data"
                                                ...
                                                <div class="btn-group">
                                                    <button class="btn-link dropdown-toggle" data-toggle="dropdown">
                                                        <img src="image/catalog/flags/gb.png" alt="English"
                                                            title="English">
                                                        <span
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <button class="btn-block language-select" type="button"
                                                                name="ar-ar"><img src="image/catalog/flags/ar.png"
                                                                    alt="Arabic" title="Arabic"> Arabic</button>
                                                        </li>
                                                        <li>
                                                            <button class="btn-block language-select" type="button"
                                                                name="en-gb"><img src="image/catalog/flags/gb.png"
                ...
                <div class="container">
                    <div class="row">
                        <div class="navbar-logo col-lg-3 col-md-12 col-xs-12">
                            <a href="index6.php"><img src="image/catalog/demo/logo/logo-home6.png"
                                                        ...
                                                        <tr>
                                                            <td class="text-center size-img-cart">
                                                                <a href="product.html"><img
                                                                        src="image/catalog/demo/product/travel/10-54x54.jpg"
                                                ...
                                                <table class="table table-striped" style="margin-bottom:10px;">
                                                    <tbody>
                                                        <tr>
                                                            <td class="text-center size-img-cart">
                                                                <a href="product.html"><img
                                                                        src="image/catalog/demo/product/travel/2-54x54.jpg"
                                                                ...
                                                                <ul class="megamenu" data-transition="slide"
                                                                    ...
                                                                    <li class="item-vertical  style1">
                                                                        ...
                                                                        <a href="#" class="clearfix">
                                                                            <span>
                                                                                <strong><img
                                                                                        src="image/catalog/demo/menu/icon/icon-6.png"
                                                                                        alt="">Hot Deal</strong>
                                                                            </span>
                                                                        </a>
                                                                    </li>
                                                                    <li
                                                                        ...
                                                                        <a class="clearfix">
                                                                            <span>
                                                                                <strong><img
                                                                                        src="image/catalog/demo/menu/icon/icon-1.png"
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <a href="#" class="clearfix">
                                                                            <span>
                                                                                <strong><img
                                                                                        src="image/catalog/demo/menu/icon/icon-2.png"
                                                                                        alt="">Travel &amp;
                                                                                    Vacation</strong>
                                                                            </span>
                                                                            <b class="fa fa-caret-right"></b>
                                                                    ...
                                                                    <li class="item-vertical">
                                                                        ...
                                                                        <a href="#" class="clearfix">
                                                                            <span>
                                                                                <strong><img
                                                                                        src="image/catalog/demo/menu/icon/icon-3.png"
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <a class="clearfix">
                                                                            <span>
                                                                                <strong><img
                                                                                        src="image/catalog/demo/menu/icon/icon-4.png"
                                                                                        alt="">Fashion</strong>
                                                                            </span>
                                                                            <b class="fa fa-caret-right"></b>
                                                                        </a>
                                                                    ...
                                                                    <li class="item-vertical">
                                                                        ...
                                                                        <a class="clearfix">
                                                                            <span>
                                                                                <strong><img
                                                                                        src="image/catalog/demo/menu/icon/icon-5.png"
                                                                                        alt="">Sport &amp;
                                                                                    Entertaiment</strong>
                                                                            </span>
                                                                        </a>
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <a href="#" class="clearfix">
                                                                            <span>
                                                                                <strong><img
                                                                                        src="image/catalog/demo/menu/icon/icon-8.png"
                                                                                        alt="">Spa &amp;
                                                                                    Massage</strong>
                                                                            </span>
                                                                            <b class="fa fa-caret-right"></b>
                                                                    ...
                                                                    <li class="item-vertical">
                                                                        ...
                                                                        <a href="#" class="clearfix">
                                                                            <span>
                                                                                <strong><img
                                                                                        src="image/catalog/demo/menu/icon/icon-9.png"
                                                                    ...
                                                                    <li class="item-vertical">
                                                                        ...
                                                                        <a href="#" class="clearfix">
                                                                            <span>
                                                                                <strong><img
                                                                                        src="image/catalog/demo/menu/icon/icon-7.png"
                                                                                        alt="">Food &amp;
                                                                                    Restaurant</strong>
                                                                            </span>
                                                                        </a>
                                                            ...
                                                            <div class="container">
                                                                <ul class="megamenu" data-transition="slide"
                                                                                            ...
                                                                                            <div class="image">
                                                                                                <a href="#"
                                                                                                    onclick="window.location = '#'"><img
                                                                                                        src="image/catalog/demo/product/fashion/24.png"
                                                                                                        alt=""></a>
                                                                                            </div>
                                                                                            <div class="name"><a
                                                                                                    href="#"
                                                                    ...
                                                                    <li class="deal-h5 hidden">
                                                                        ...
                                                                        <a href="#" class="clearfix">
                                                                            <strong>
                                                                                <img src="image/catalog/demo/menu/hot-block.png"
                                                                                    alt="">Buy This Theme!
                                                                            </strong>
                                                                        </a>
                                                                    </li>
                                        ...
                                        <div class="so-homeslider yt-content-slider full_slider owl-drag" data-rtl="yes"
                                            ...
                                            <div class="item">
                                                <a href=" #   " title="slide 6 - 1" target="_self">
                                                    <img class="responsive"
                                                        src="image/catalog/demo/slider/home6/slider-31.jpg"
                                                        alt="slide 6 - 1">
                                                </a>
                                            ...
                                            <div class="item">
                                                <a href=" #   " title="slide 6 - 2" target="_self">
                                                    <img class="responsive"
                                                        src="image/catalog/demo/slider/home6/slider-32.jpg"
                                                        alt="slide 6 - 2">
                                                </a>
                                                <div class="sohomeslider-description">
                                                </div>
                                            ...
                                            <div class="item">
                                                <a href=" #   " title="slide 6 - 3" target="_self">
                                                    <img class="responsive"
                                                        src="image/catalog/demo/slider/home6/slider-33.jpg"
                                                        alt="slide 6 - 3">
                                                </a>
                                                <div class="sohomeslider-description">
                                                </div>
                                            ...
                                            <div class="item">
                                                <a href=" #   " title="slide 6 - 4" target="_self">
                                                    <img class="responsive"
                                                        src="image/catalog/demo/slider/home6/slider-34.jpg"
                                                        alt="slide 6 - 4">
                                                </a>
                                                <div class="sohomeslider-description">
                                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col_mdsk col-style">
                            <div class="banner-layout-2 h6-banner-1 clearfix">
                                <div class="banner-1 banners">
                                    <div>
                                        <a href="#" title="Banner 2">
                                            <img src="image/catalog/demo/banners/home6/home6_1.jpg" alt="Static Image">
                                        </a>
                                    </div>
                                </div>
                                <div class="banner-2 banners">
                                    <div>
                                        <a href="#" title="Banner 2">
                                            <img src="image/catalog/demo/banners/home6/home6_2.jpg" alt="Static Image">
                                        </a>
                                    </div>
                                ...
                                <div class="banner-3 banners">
                                    <div>
                                        <a href="#" title="Banner 2">
                                            <img src="image/catalog/demo/banners/home6/home6_4.jpg" alt="Static Image">
                                        </a>
                                    </div>
                                </div>
                                <div class="banner-4 banners">
                                    <div>
                                        <a href="#" title="Banner 2">
                                            <img src="image/catalog/demo/banners/home6/home6_3.jpg" alt="Static Image">
                                        </a>
                                    </div>
                                ...
                                <div class="banner-5 banners">
                                    <div>
                                        <a href="#" title="Banner 2">
                                            <img src="image/catalog/demo/banners/home6/home6_6.jpg" alt="Static Image">
                                        </a>
                                    </div>
                                </div>
                                <div class="banner-6 banners">
                                    <div>
                                        <a href="#" title="Banner 2">
                                            <img src="image/catalog/demo/banners/home6/home6_5.jpg" alt="Static Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <ul class="cate-html-item contentslider" data-rtl="no" data-loop="no"
                                    ...
                                    <li class="item">
                                        <div class="item-image"><a title="Static Image" href="#"><img
                                                    src="image/catalog/demo/banners/home3/cate-1.jpg"
                                    ...
                                    <li class="item">
                                        <div class="item-image"><a title="Static Image" href="#"><img
                                                    src="image/catalog/demo/banners/home3/cate-2.jpg"
                                                    alt="Static Image"></a></div>
                                        <div class="item-content">
                                    ...
                                    <li class="item">
                                        <div class="item-image"><a title="Static Image" href="#"><img
                                                    src="image/catalog/demo/banners/home3/cate-3.jpg"
                                                    alt="Static Image"></a></div>
                                        <div class="item-content">
                                    ...
                                    <li class="item">
                                        <div class="item-image"><a title="Static Image" href="#"><img
                                                    src="image/catalog/demo/banners/home3/cate-4.jpg"
                                                    alt="Static Image"></a></div>
                                        <div class="item-content">
                                    ...
                                    <li class="item">
                                        <div class="item-image"><a title="Static Image" href="#"><img
                                                    src="image/catalog/demo/banners/home3/cate-5.jpg"
                                                    alt="Static Image"></a></div>
                                        <div class="item-content">
                                            <h4><a href="#">Health Care</a></h4>
                                        </div>
                                    ...
                                    <li class="item">
                                        <div class="item-image"><a title="Static Image" href="#"><img
                                                    src="image/catalog/demo/banners/home3/cate-6.jpg"
                                                    alt="Static Image"></a></div>
                                        <div class="item-content">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_1x14">
                                        <div class="qr-code-block block">
                                            <div class="item-image">
                                                <img src="image/catalog/demo/banners/home6/qr.png" alt="" width="65"
                                                    height="65">
                                            </div>
                                            <div class="item-content">
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                ...
                                                                                <img src="image/catalog/demo/product/fashion/5-60x60.png"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                ...
                                                                                <img src="image/catalog/demo/product/fashion/15-60x60.png"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                ...
                                                                                <img src="image/catalog/demo/product/fashion/21-60x60.png"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                target="_blank"
                                                                                title="Est Officia Including Shoes Beautiful Pi..">
                                                                                <img src="image/catalog/demo/product/fashion/24-60x60.png"
                                                                                    alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                            </a>
                                                                        </div>
                                                                        <div class="box-label">
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                ...
                                                                                <img src="image/catalog/demo/product/fashion/14-60x60.png"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                ...
                                                                                <img src="image/catalog/demo/product/fashion/10-60x60.jpg"
                                        ...
                                        <div class="banner-layout-3 bt-1 clearfix banners">
                                            <div class="">
                                                <a class="bn-shadow" href="#" title="Banner 1">
                                                    <img src="image/catalog/demo/banners/home6/01.jpg"
                                                        alt="Static Image">
                                                </a>
                                            </div>
                                        </div>
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                ...
                                                                                <img src="image/catalog/demo/product/electronic/25-210x210.jpg"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                ...
                                                                                <img src="image/catalog/demo/product/electronic/19-210x210.jpg"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                ...
                                                                                <img src="image/catalog/demo/product/electronic/4-210x210.jpg"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                ...
                                                                                <img src="image/catalog/demo/product/electronic/1-210x210.png"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                ...
                                                                                <img src="image/catalog/demo/product/electronic/11-210x210.jpg"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div
                                                                            ...
                                                                            <a class="lt-image" href="product.html"
                                                                                ...
                                                                                <img src="image/catalog/demo/product/electronic/13-210x210.jpg"
                                        ...
                                        <div class="block-testimonial bn-shadow">
                                            <div class="testimonial-items contentslider" data-rtl="no" data-loop="no"
                                                ...
                                                <div class="item">
                                                    ...
                                                    <div class="img"><img
                                                            src="image/catalog/demo/banners/home3/user-2.jpg"
                                                ...
                                                <div class="item">
                                                    ...
                                                    <div class="img"><img
                                                            src="image/catalog/demo/banners/home3/user-1.jpg"
                                                            alt="Static Image"></div>
                                                ...
                                                <div class="item">
                                                    ...
                                                    <div class="img"><img
                                                            src="image/catalog/demo/banners/home3/user-3.jpg"
                                                            alt="Static Image"></div>
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div class="product-image-container">
                                                                            <div class="image so-quickview">
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    target="_self">
                                                                                    <img src="image/catalog/demo/product/electronic/1-226x226.jpg"
                                                                                        alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div class="product-image-container">
                                                                            <div class="image so-quickview">
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    target="_self">
                                                                                    <img src="image/catalog/demo/product/electronic/11-226x226.jpg"
                                                                                        alt="Charger  Compact Portable with Premium"
                                                                                        class="img-responsive">
                                                                                </a>
                                                                            </div>
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div class="product-image-container">
                                                                            <div class="image so-quickview">
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    target="_self">
                                                                                    <img src="image/catalog/demo/product/electronic/26-226x226.jpg"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div class="product-image-container">
                                                                            <div class="image so-quickview">
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    target="_self">
                                                                                    <img src="image/catalog/demo/product/electronic/6-226x226.jpg"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div class="product-image-container">
                                                                            <div class="image so-quickview">
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    target="_self">
                                                                                    <img src="image/catalog/demo/product/electronic/29-226x226.jpg"
                                                                    ...
                                                                    <div class="left-block ">
                                                                        <div class="product-image-container">
                                                                            <div class="image so-quickview">
                                                                                ...
                                                                                <a class="lt-image" href="product.html"
                                                                                    target="_self">
                                                                                    <img src="image/catalog/demo/product/electronic/19-226x226.jpg"
                                                                                        alt="Compact Portable Charger (Power Bank) with Premium"
                                                                                        class="img-responsive">
                                                                                </a>
                                                                            </div>
                                        ...
                                        <div class="banner-21 banner">
                                            <div>
                                                <a class="bn-shadow" href="#" title="Banner 24">
                                                    <img src="image/catalog/demo/banners/home6/banner21.jpg"
                                                        alt="Static Image">
                                                </a>
                                            </div>
                                        </div>
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                target="_self"
                                                                                                title="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                                                <img src="image/catalog/demo/product/fashion/24-226x226.png"
                                                                                                    alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="box-label">
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                <img src="image/catalog/demo/product/fashion/16-226x226.png"
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                target="_self"
                                                                                                title="Ligula tortoram ut labore et dolore magna elip">
                                                                                                <img src="image/catalog/demo/product/fashion/14-226x226.png"
                                                                                                    alt="Ligula tortoram ut labore et dolore magna elip">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="box-label">
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                target="_self"
                                                                                                title="Ligula tortoram ut labore et dolore magna elip">
                                                                                                <img src="image/catalog/demo/product/fashion/11-226x226.png"
                                                                                                    alt="Ligula tortoram ut labore et dolore magna elip">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="box-label">
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                <img src="image/catalog/demo/product/fashion/18-226x226.png"
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                target="_self"
                                                                                                title="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                                                <img src="image/catalog/demo/product/fashion/15-226x226.png"
                                                                                                    alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="box-label">
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                target="_self"
                                                                                                title="Compact Portable Charger (External Battery)">
                                                                                                <img src="image/catalog/demo/product/electronic/13-270x270.jpg"
                                                                                                    alt="Compact Portable Charger (External Battery)">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="box-label">
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                target="_self"
                                                                                                title="Charger  Compact Portable with Premium">
                                                                                                <img src="image/catalog/demo/product/electronic/11-270x270.jpg"
                                                                                                    alt="Charger  Compact Portable with Premium">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="box-label">
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                <img src="image/catalog/demo/product/electronic/14-270x270.jpg"
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                <img src="image/catalog/demo/product/electronic/21-270x270.jpg"
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                target="_self"
                                                                                                title="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                                                                                <img src="image/catalog/demo/product/electronic/26-270x270.jpg"
                                                                                                    alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="box-label">
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                target="_self"
                                                                                                title="Mammo Diablo except to obtain some advan from">
                                                                                                <img src="image/catalog/demo/product/electronic/6-270x270.jpg"
                                                                                                    alt="Mammo Diablo except to obtain some advan from">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="box-label">
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                target="_self"
                                                                                                title="Portable  Compact Charger (External Battery) t45">
                                                                                                <img src="image/catalog/demo/product/electronic/4-270x270.jpg"
                                                                                                    alt="Portable  Compact Charger (External Battery) t45">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="box-label">
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                <img src="image/catalog/demo/product/electronic/28-270x270.jpg"
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                target="_self"
                                                                                                title="Compact Portable Charger (Power Bank) with Premium">
                                                                                                <img src="image/catalog/demo/product/electronic/19-270x270.jpg"
                                                                                                    alt="Compact Portable Charger (Power Bank) with Premium">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="box-label">
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                <img src="image/catalog/demo/product/electronic/5-270x270.jpg"
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                <img src="image/catalog/demo/product/electronic/9-270x270.jpg"
                                                                                    ...
                                                                                    <div class="left-block ">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="lt-image"
                                                                                                ...
                                                                                                <img src="image/catalog/demo/product/electronic/17-270x270.jpg"
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_4kdf block">
                                        <div class="banner-layout-5 row clearfix">
                                            <div class="banner-22 col-sm-4  banners">
                                                <div>
                                                    <a class="bn-shadow" href="#" title="Banner 22">
                                                        <img src="image/catalog/demo/banners/home6/banner22.jpg"
                                                            alt="Static Image">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="banner-23 col-sm-4 banners">
                                                <div>
                                                    <a class="bn-shadow" href="#" title="Banner 23">
                                                        <img src="image/catalog/demo/banners/home6/banner23.jpg"
                                                            alt="Static Image">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="banner-24 col-sm-4  banners">
                                                <div>
                                                    <a class="bn-shadow" href="#" title="Banner 24">
                                                        <img src="image/catalog/demo/banners/home6/banner24.jpg"
                                                            alt="Static Image">
                                                    </a>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        target="_self"
                                                                        title="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                                                                        <img src="image/catalog/demo/product/electronic/25-234x234.jpg"
                                                                            alt="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        target="_self"
                                                                        title="Compact Portable Charger (Power Bank) with Premium">
                                                                        <img src="image/catalog/demo/product/electronic/19-234x234.jpg"
                                                                            alt="Compact Portable Charger (Power Bank) with Premium">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        target="_self"
                                                                        title="Portable  Compact Charger (External Battery) t45">
                                                                        <img src="image/catalog/demo/product/electronic/4-234x234.jpg"
                                                                            alt="Portable  Compact Charger (External Battery) t45">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        target="_self"
                                                                        title=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus">
                                                                        <img src="image/catalog/demo/product/electronic/1-234x234.jpg"
                                                                            alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        target="_self"
                                                                        title="Charger  Compact Portable with Premium">
                                                                        <img src="image/catalog/demo/product/electronic/11-234x234.jpg"
                                                                            alt="Charger  Compact Portable with Premium">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        target="_self"
                                                                        title="Compact Portable Charger (External Battery)">
                                                                        <img src="image/catalog/demo/product/electronic/13-234x234.jpg"
                                                                            alt="Compact Portable Charger (External Battery)">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        target="_self"
                                                                        title="Compact Portable Charger (External Battery) T22">
                                                                        <img src="image/catalog/demo/product/electronic/21-234x234.jpg"
                                                                            alt="Compact Portable Charger (External Battery) T22">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        target="_self"
                                                                        title="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                                                        <img src="image/catalog/demo/product/electronic/26-234x234.jpg"
                                                                            alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        target="_self"
                                                                        title="Mammo Diablo except to obtain some advan from">
                                                                        <img src="image/catalog/demo/product/electronic/6-234x234.jpg"
                                                                            alt="Mammo Diablo except to obtain some advan from">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        target="_self"
                                                                        title="Seneo PA046 Fast Charger  Wireless Sleep-Friendly)">
                                                                        <img src="image/catalog/demo/product/electronic/29-234x234.jpg"
                                                                            alt="Seneo PA046 Fast Charger  Wireless Sleep-Friendly)">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        target="_self"
                                                                        title="Compact Portable Charger (External Battery) T21">
                                                                        <img src="image/catalog/demo/product/electronic/14-234x234.jpg"
                                                                            alt="Compact Portable Charger (External Battery) T21">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" href="product.html"
                                                                        ...
                                                                        <img src="image/catalog/demo/product/electronic/20-234x234.jpg"
                                    ...
                                    <div class="banner-25 col-sm-6 banners">
                                        <div>
                                            <a class="bn-shadow" href="#" title="Banner 25">
                                                <img src="image/catalog/demo/banners/home6/banner25.jpg"
                                                    alt="Static Image">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="banner-26 col-sm-6  banners">
                                        <div>
                                            <a class="bn-shadow" href="#" title="Banner 26">
                                                <img src="image/catalog/demo/banners/home6/banner26.jpg"
                                                    alt="Static Image">
                                            </a>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript" src="{{ asset('public') }}/js/dcjqaccordion/jquery.dcjqaccordion.2.8.min.js"></script>
